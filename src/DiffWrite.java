...
public class DiffWrite {
    ...
    public static void main(String[] args) throws IOException {
        File in = new File("D:\\Java\\NIO\\in.txt");
        File out = new File("D:\\Java\\NIO\\out.txt");
    ...
    static void copyFile(File in, File out) throws IOException{
        ...
        try(FileInputStream fis = new FileInputStream("D:\\Java\\NIO\\in.txt");
            FileOutputStream fos = new FileOutputStream("D:\\Java\\NIO\\out.txt")) {
